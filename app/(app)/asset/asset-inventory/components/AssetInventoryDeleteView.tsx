...
export default function AssetInventoryDeleteView({ deleteTarget, onCancel, onConfirm }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-5">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm">
                ...
                {/* メッセージ */}
                <h3 className="text-center text-lg font-bold text-slate-800 mb-1">資産を削除</h3>
